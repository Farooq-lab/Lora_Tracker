...
/**
  ...
  */
#define PROBE_LINE1_PIN                           GPIO_PIN_11
...
/**
  ...
  */
#define PROBE_LINE2_PIN                           GPIO_PIN_12

/**
  * @brief Port of Probe Line 2
  */
#define PROBE_LINE2_PORT                          GPIOA

/**
  * @brief Enable GPIOs clock of Probe Line 2
  */
#define PROBE_LINE2_CLK_ENABLE()                  __HAL_RCC_GPIOA_CLK_ENABLE()

/**
  * @brief Disable GPIOs clock of Probe Line 2
  */
#define PROBE_LINE2_CLK_DISABLE()                 __HAL_RCC_GPIOA_CLK_DISABLE()

/**  Definition for Probe Line 3   **/
/**
  * @brief Pin of Probe Line 3
  */
#define PROBE_LINE3_PIN                           GPIO_PIN_2
...
/**
  ...
  */
#define PROBE_LINE4_PIN                           GPIO_PIN_14
