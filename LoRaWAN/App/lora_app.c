            ...
            case LORAWAN_USER_APP_PORT:
              if (appData->BufferSize == 1)
              {
                ...
                if (AppLedStateOn == RESET)
                {
                  ...
                  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_3, GPIO_PIN_SET); /* LED_RED */
                }
                else
                {
                  APP_LOG(TS_OFF, VLEVEL_H, "LED ON\r\n");
                  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_3, GPIO_PIN_RESET); /* LED_RED */
                }
              }
              break;
...
static void SendTxData(void)
{
  ...
  {
    APP_LOG(TS_ON, VLEVEL_L, "join REQUEST ss \r\n");
    UTIL_TIMER_Stop(&JoinLedTimer);
    APP_LOG(TS_ON, VLEVEL_L, "join REQUEST ss11\r\n");
#if 0   // XXX:
  ...
  // {
  //   APP_LOG(TS_ON, VLEVEL_L, "SEND REQUEST ss \r\n");
  // }
